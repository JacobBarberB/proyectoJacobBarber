  ...
  <div id="subBody">
    ...
    <section id="seccion-menu" class="containerBody menu_sand">
      <div class="col-12 div-menu-seccion text-2 size-37">
        ...
        <a style="text-decoration: underline;" href="pagina_sandwiches.php">SANDWICHES</a>
          ...
          <div class=" navbar-collapse estrellas text-4">
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                ...
                <a class="starSand" href="pagina_sandwiches.php">SANDWICHES</a>
                <img class="" src="assets/images/star_1.png">               
              </li>
              <li class="nav-item">
            ...
            <div class="producto_btn">
              ...
              <div id="myModal<?php echo $key; ?>" class="modalContainer" tabindex="-1">
                ...
                <div class="modal-content col-xs-6">
                  ...
                  <div>
                    <?php
                    foreach (INGREDIENTES::ALL_INGREDIENTS_SANDWICHES as $ingre_burg) { ?>
