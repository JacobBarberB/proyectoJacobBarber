...
class BURGER extends PRODUCTO {
    ...
    public function __construct(int $id_producto, string $nombre_producto, string $descripcion, float $precio_producto, $imagen, array $ingrediente = []){
        parent::__construct($id_producto, $nombre_producto, $descripcion, $precio_producto, $imagen, CATEGORIA::BURGUER);
        
        $this->ingrediente[] = new INGREDIENTES('pan_burger');
        $this->ingrediente[] = new INGREDIENTES('carne');
