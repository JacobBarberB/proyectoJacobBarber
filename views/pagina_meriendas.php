...
?>
    <section id="seccion-menu" class="containerBody menu_meri">
      <div class="col-12 div-menu-seccion text-2 size-37">
        ...
        <a style="text-decoration: underline;" href=<?= base_url . "carta/meriendas"?>>MERIENDAS</a>
      </div>
    </section>
    <section>
          ...
          <div class=" navbar-collapse estrellas text-4">
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                ...
                <a class="starMeri" href=<?= base_url."carta/meriendas"?>>MERIENDAS</a>
                <img class="" src="../assets/images/star_1.svg">
              </li>
            </ul>
          </div>
            ...
            <div class="producto_btn">
              ...
              <div id="myModal<?php echo $key; ?>" class="modalContainer" tabindex="-1">
                ...
                <div class="modal-content col-xs-6">
                  ...
                  <div>
                    <?php
                    foreach (productodao::ingredienteProducto($lista->getId_producto()) as $ingre_meri) { ?>
                      <label class="text-3 size-20 ps-2 pe-0 ps-lg-4 pe-lg-1"><?php echo $ingre_meri->getNombre_ingred() ?></label>
                      <label class="text-3 size-20 ps-0 pe-0 pe-lg-1"><?php echo $ingre_meri->getPrecio_ingred() ?>€</label>
                      <input type="checkbox" name="ingredientes-<?php echo $key; ?>[]" <?php if($ingre_meri->getNombre_ingred() == "leche"){ ?>checked disabled<?php } elseif ($ingre_meri->getActivo() == 1) { ?>checked<?php } ?> value="<?php echo $ingre_meri->getId_ingrediente(); ?>" />
                    <?php }
                    ?>
                  </div>
